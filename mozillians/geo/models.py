...
class Country(models.Model):
    ...
    name = models.CharField(
        max_length=120, unique=True, help_text="name field from Mapbox"
    )
    code = models.CharField(
        max_length=2, help_text="lowercased 2-letter code from Mozilla product data"
    )
    mapbox_id = models.CharField(
        max_length=40, unique=True, help_text="'id' field from Mapbox"
    )
...
class Region(models.Model):
    ...
    name = models.CharField(max_length=120, help_text="name field from Mapbox")
    mapbox_id = models.CharField(
        max_length=40, unique=True, help_text="'id' field from Mapbox"
    )
