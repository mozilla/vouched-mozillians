...
ES_INDEXES = {"default": "mozillians-test", "public": "mozillians-public-test"}


@override_settings(
    AUTHENTICATION_BACKENDS=AUTHENTICATION_BACKENDS, PASSWORD_HASHERS=PASSWORD_HASHERS
)
    ...
    def decorate(func):
        def newfunc(*args, **kwargs):
            with nested(
                ...
                patch(
                    "mozillians.common.middleware.login_required", wraps=login_required
                ),
            ) as (messages_mock, login_mock):
                func(*args, **kwargs)
    ...
    def decorate(func):
        def newfunc(*args, **kwargs):
            with nested(
                ...
                patch("mozillians.common.middleware.redirect", wraps=redirect),
            ) as (messages_mock, redirect_mock):
                func(*args, **kwargs)
            ok_(messages_mock.called, "messages.warning() was not called.")
