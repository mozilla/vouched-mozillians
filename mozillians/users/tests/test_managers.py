...
class UserProfileQuerySetTests(TestCase):
    ...
    def test_public(self, mock_privacy_fields):
        ...
        eq_(
            set(queryset.all()),
            set([public_user_1.userprofile, public_user_2.userprofile]),
        )
    ...
    def test_complete(self):
        ...
        eq_(
            set(queryset.all()),
            set([complete_user_1.userprofile, complete_user_2.userprofile]),
        )

    @patch(
        "mozillians.users.managers.PUBLIC_INDEXABLE_FIELDS",
        {"full_name": "", "email": ""},
    )
    def test_public_indexable(self):
        ...
        eq_(
            ...
            set(
                [
                    public_indexable_user_1.userprofile,
