    ...
    def queryset(self, request, queryset):
        ...
        if self.value() == "<7":
            ...
            return queryset.filter(
                user__last_login__lt=get_datetime(-180),
...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (None, {"fields": ("date_mozillian",)}),
        ("Important dates", {"fields": ("date_joined", "last_login")}),
        ("Vouch Info", {"fields": ("date_vouched", "is_vouched", "can_vouch")}),
        (
            "Privacy Settings",
            {
                "fields": (
...
class VouchAdmin(admin.ModelAdmin):
    save_on_top = True
    search_fields = [
        "voucher__user__username",
        "voucher__full_name",
        "vouchee__user__username",
        "vouchee__full_name",
        "voucher__user__email",
        "vouchee__user__email",
        "description",
    ]
